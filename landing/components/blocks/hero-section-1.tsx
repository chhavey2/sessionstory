            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  <Link
                    href="#link"
                    className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 px-4 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950"
                  >
                ...
                >
                  ...
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="md:hidden h-10.5 rounded-xl px-5 w-full max-w-[240px] mb-[50%]"
                  >
                    <Link
                      href="https://player.sessionstory.co/session_1770393543671_mmr5l3l"
                      target="_blank"
                      className="flex items-center gap-2"
                    >
                      <span className="text-nowrap">Watch Demo Recording</span>
